...
const DIRECTOR_TITLE = 'TheBuffaloFree Director';
...
const PLAY_CLOSED_TESTING_URL = 'https://play.google.com/apps/testing/org.buffalobuynothing.app';

/** Canonical Updates feed — current APK plus later posts. */
export const SEEDED_APP_UPDATES: SeededAppUpdate[] = [
  {
    id: '2026-08-25_apk-0053',
    date: '2026-08-25',
    title: 'TheBuffaloFree — beta v0.2.0.0053',
    body: 'Home-screen icon now matches the Buffalo blue logo on the website — no more white box behind the hands.',
    detail: `WHAT NEIGHBORS SEE
TheBuffaloFree, 0.2.0 (53): Buffalo blue squircle on your phone and on the site.

• Home-screen icon matches the website — Buffalo blue with 3D hands
• Removed the white square matte behind the logo artwork
• Same sign-in, listings, map, chat, and notifications
• Package stays org.buffalobuynothing.app — your account is unchanged
...
— Mark`,
    ...
    createdAt: APK_0053_AT,
    updatedAt: APK_0053_AT,
  },
  {
    id: '2026-08-21_apk-0052',
    date: '2026-08-21',
    title: 'TheBuffaloFree — beta v0.2.0.0052',
    body: 'Classic app layout with a black-and-white look. Same community, same account — still TheBuffaloFree.',
    detail: `WHAT NEIGHBORS SEE
TheBuffaloFree, 0.2.0 (52): original layout restored with black-and-white styling.

• Home screen and app switcher say **TheBuffaloFree**
• Same sign-in, listings, map, chat, and notifications
• Package stays org.buffalobuynothing.app — your account is unchanged
• Opt in on closed testing if you have not yet: ${PLAY_CLOSED_TESTING_URL}
...
— Mark`,
  ...
  },
  {
    ...
    date: '2026-08-21',
    title: 'TheBuffaloFree — beta v0.2.0.0051',
    body: 'Smaller lockup on the home page. Map filters and listing cards no longer overlap or get cut off.',
    detail: `WHAT NEIGHBORS SEE
TheBuffaloFree, 0.2.0 (51): same app, tighter fit.

• TheBuffaloFree lockup is a small crest — not a full-screen poster
...
— Mark`,
    ...
    postedByUserId: CHANGELOG_AUTHOR_UID,
    createdAt: HOSTING_OUTAGE_NEWS_AT,
    updatedAt: HOSTING_OUTAGE_NEWS_AT,
  },
  {
...
TheBuffaloFree name and look changed recently — that was immediate once the update shipped. The next change is different: we will move to a new website link and a new Android app download link. That is still coming, not live yet.

What to expect:
• A new web address for TheBuffaloFree (buffalobuynothing.com may keep working for a while as a redirect)
...
411 neighbors from our community are already on the TheBuffaloFree closed-testing email list in Google Play Console (pulled from neighbors who joined through the site).
...
3. Install TheBuffaloFree from the Play Store
