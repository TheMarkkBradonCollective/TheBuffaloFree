...
Our name — "Buy Nothing" — runs into trademarks and brands that aren't ours. I've turned it over every way I can think of, and I don't know what else to do except shut Buffalo Buy Nothing down: take the site off, pull the apps, and say goodbye.
...
— Mark
TheBuffaloFree Director, Buffalo`;
...
export const TRADEMARK_HOME_NOTICE = {
  ...
  body: `TheBuffaloFree is the community's published name and visual identity.
...
Our name hits trademarks we don't own. I've tried everything I can think of — I don't know what else to do but shut Buffalo Buy Nothing down.
...
• buffalobuynothing.com now shows an official trademark notice on the home page — we are independent and working on a distinct name
