...
512×512 **32-bit PNG** (Play rejects 24-bit RGB). Generated from `public/TheBuffaloFree.png` — the same masthead lockup as the website. The lockup is scaled down and centered with newsprint padding so Play’s circular mask does not clip the wordmark.
...
| Order | File | Screen |
|-------|------|--------|
| 1 | `01-home.png` | Public newspaper home — The Buffalo Free |
