 ...
 * from notification-icon.png hands on a clean Buffalo blue squircle.
 *
 * Avoids flood-fill / matte inpainting that smears blue into the white hands.
 */
...
def make_popout():
    ...
    draw.rounded_rectangle([PAD, PAD, SIZE - PAD - 1, SIZE - PAD - 1], radius=RADIUS, fill=BLUE)
