...
/** Buffalo blue accent — matches --color-accent in src/index.css */
const launcherBg = '#00338d';
...
function assertLauncherForeground(pngPath) {
  ...
  if (greenish < 80) {
    throw new Error(`Expected Buffalo blue artwork in ${pngPath}, found ${greenish} greenish pixels.`);
  }
}
