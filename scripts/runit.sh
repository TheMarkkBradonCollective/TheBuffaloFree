...
echo "═══════════════════════════════════════════════════════════════"
echo "  /runit — Buffalo Buy Nothing full release"
echo "═══════════════════════════════════════════════════════════════"
...
AAB_URL="https://www.buffalobuynothing.com/downloads/${AAB_FILE}"
APK_URL="https://www.buffalobuynothing.com/downloads/${APK_FILE}"
...
const manifest = {
  ...
  aabDownloadUrl: \`https://www.buffalobuynothing.com/downloads/sac-buy-nothing-beta-v\${versionName}.\${build}.aab\`,
