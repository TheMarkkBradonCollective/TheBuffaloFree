...
EXTRA = [
    (
        ...
        "Desktop stayed the same — mobile got a full-screen Buffalo map with colored blips per category and a Map Colors Index to filter.\n\n— Mark",
    ),
    (
    ...
    (
        ...
        "Map uses OpenStreetMap now — real Buffalo streets.\n\n— Mark",
    ),
...
VOICE: dict[str, tuple[str, str]] = {
    "2026-05-19_where-it-all-started": (
        ...
        "This is day one. I sat down and started building Buffalo Buy Nothing — log in, post gives and asks, profiles, messaging. That's the whole idea.\n\n— Mark",
    ),
    "2026-05-19_buffalo-buy-nothing-launches": (
        "Buffalo Buy Nothing is live",
        "Site went live — free place for Buffalo neighbors to give, ask, and connect. No money.\n\n— Mark",
    ),
    ...
    "2026-05-19_sacramento-neighborhood-list": (
        ...
        "When you join you pick your Buffalo area so posts stay local to your part of town.\n\n— Mark",
    ),
    ...
    "2026-05-19_orange-sage-branding": (
        ...
        "Gave it reddit orange and sage green — wanted it to feel like Buffalo, not some random app.\n\n— Mark",
    ),
    ...
    "2026-05-20_install-on-your-home-screen": (
        "add to home screen",
        "You can add Buffalo Buy Nothing to your phone like an app — works offline for basic browsing.\n\n— Mark",
    ),
    ...
    "2026-05-29_38-sacramento-neighborhoods": (
        ...
        "Expanded the neighborhood list — 38 Buffalo areas to pick from.\n\n— Mark",
    ),
...
def narrative_depth(entry_id: str, summary: str) -> str:
    ...
    parts.append(
        "I am Markeith White — I build and run Buffalo Buy Nothing in my spare time. "
    ...
    if kind == "fix":
        ...
        parts.append(
            "Buffalo is growing and I cannot be the only pair of eyes on reports, tickets, and safety. "
        ...
        parts.append(
            ...
            "no flipping listings for cash. Each layer on top of that is about making generosity easier in Buffalo."
        )
    else:
        parts.append(
...
TECH_TO_PLAIN: list[tuple[str, str]] = [
    ...
    (r"OpenStreetMap", "OpenStreetMap (real Buffalo streets, not fake straight lines)"),
...
DETAIL_OVERRIDES: dict[str, str] = {
    "2026-05-19_where-it-all-started": (
        "What you'll notice:\n"
        "May 19, 2026 was day one — Buffalo Buy Nothing went from an idea to something you could actually open in a browser.\n\n"
        "How it works:\n"
        ...
        "Why I built it:\n"
        "I wanted a Buffalo-specific home for Buy Nothing culture instead of fighting Facebook groups or apps that "
    ...
    "2026-05-29_director-role-management": (
        ...
        "Why I changed it:\n"
        "One person cannot watch every report and ticket as Buffalo grows. Trusted neighbors need tools without "
