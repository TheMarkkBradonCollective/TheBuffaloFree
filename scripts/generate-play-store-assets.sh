...
drawtext=fontfile=${FONT_BOLD}:text='The Buffalo Free':fontsize=44:fontcolor=0x0b0b0c:x=448:y=148,\
drawtext=fontfile=${FONT_SEMI}:text='Give freely. Ask kindly.':fontsize=32:fontcolor=0x0a0a0a:x=448:y=214,\
drawtext=fontfile=${FONT_SEMI}:text='No selling  ·  No ads  ·  Buffalo neighbors':fontsize=22:fontcolor=0x52525B:x=448:y=278" \
