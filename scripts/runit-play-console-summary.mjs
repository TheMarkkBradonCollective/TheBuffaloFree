...
const aabPublicUrl = `https://www.buffalobuynothing.com/downloads/${aabFile}`;
const apkPublicUrl = `https://www.buffalobuynothing.com/downloads/sac-buy-nothing-beta-v${versionName}.${build}.apk`;
const playStoreBetaUrl = 'https://play.google.com/apps/testing/org.buffalobuynothing.app';
...
const lines = [
  ...
  '',
  'Steps — upload build:',
  '  1. Open Play Console → BuffaloBuyNothing',
  ...
  '  2. App name: TheBuffaloFree',
  '  3. Short description (80 chars): Buffalo neighbor gifting — give items, request what you need, meet locally.',
  '  4. Update full description to say TheBuffaloFree instead of BuffaloBuyNothing',
