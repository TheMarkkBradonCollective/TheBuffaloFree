...
export function loadConfig() {
  ...
  return {
    ...
    origin: process.env.FIELD_TEST_ORIGIN || process.env.PLAY_SCREENSHOT_ORIGIN || 'https://www.buffalobuynothing.com',
    chromePath: process.env.CHROME_PATH || '/usr/local/bin/google-chrome',
    posterEmail: process.env.FIELD_TEST_POSTER_EMAIL || 'field-test-poster@buffalobuynothing.com',
    posterPassword: process.env.FIELD_TEST_POSTER_PASSWORD || 'FieldTest-Poster-2026!',
    neighborEmail: process.env.FIELD_TEST_NEIGHBOR_EMAIL || 'field-test-neighbor@buffalobuynothing.com',
    ...
    neighborhood: process.env.FIELD_TEST_NEIGHBORHOOD || 'Elmwood Village',
    geolocation: {
    ...
    packageName: 'org.buffalobuynothing.app',
    mainActivity: 'org.buffalobuynothing.app/.MainActivity',
