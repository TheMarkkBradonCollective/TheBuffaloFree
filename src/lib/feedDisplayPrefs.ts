...
const VIEW_MODE_KEY = 'tbf_feed_view_mode_v1';
const EVENTS_VIEW_MODE_KEY = 'tbf_events_view_mode_v1';

export type { FeedViewMode, FeedContentFilter, FeedAudienceScope };

const FEED_CONTENT_FILTER_KEY = 'tbf_feed_content_filter_v1';

const FEED_AUDIENCE_SCOPE_KEY = 'tbf_feed_audience_scope_v1';
