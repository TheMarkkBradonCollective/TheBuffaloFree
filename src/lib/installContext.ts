...
export const INSTALLED_WEB_VERSION_KEY = 'tbf_installed_web_version_v1';
export const INSTALLED_APK_VERSION_CODE_KEY = 'tbf_installed_apk_version_code_v1';
export const INSTALLED_APK_VERSION_NAME_KEY = 'tbf_installed_apk_version_name_v1';
