  ...
  switch (eligibility.reason) {
    case 'need_install':
      return {
        ...
        message:
          'Pickup coordination (Go Get, Drop off, Meet up, and claim-at-pin) only works in the Buffalo Buy Nothing Android app (APK or Play Store). Install from Download in Account, turn on notifications, then enable coordination in Account settings.',
        okLabel: 'Got it',
      };
