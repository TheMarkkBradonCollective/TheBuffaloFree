...
export const ROLE_LABELS: Record<UserRole, string> = {
  ...
  director: 'TheBuffaloFree Director',
};
 ...
 * on-brand Buffalo blue, staff ranks step up through blue → teal → violet → deeper green.
 */
...
export const ASSIGNABLE_ROLE_OPTIONS: {
  ...
  },
  {
    ...
    description: 'TheBuffaloFree Director — full owner-level access',
  },
];
...
/** Buffalo Buy Nothing Director — full platform oversight. */
