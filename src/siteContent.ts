/** In-app logo and site lockup — Buffalo blue rounded-square icon (`download (6).png`). */
export const APP_LOGO_SRC = '/app-icon.png';
/** Homescreen / PWA / favicon — same Buffalo blue rounded-square app icon. */
...
export const SITE = {
  name: 'TheBuffaloFree',
  shortName: 'TheBuffaloFree',
  url: 'https://www.buffalobuynothing.com',
  tagline: COMMUNITY_SLOGAN,
  description:
    'A community-powered platform where people in Buffalo can give away items they no longer need — completely free.',
  metaDescription:
    'TheBuffaloFree — free local gifting in Buffalo. No selling, no bidding, no flipping. Neighbors helping neighbors.',
  principles: ['No selling.', 'No bidding.', 'No flipping.', 'Just neighbors helping neighbors.'],
  freeRule: 'Everything posted must be 100% free.',
  downloadHelper:
    'Google Play on Android for live Go Get pickup (if invited), or add TheBuffaloFree to your home screen — the website works either way.',
  /** Google Play closed testing — opt in on the web, then install from the store listing. */
  playStoreBetaUrl: 'https://play.google.com/apps/testing/org.buffalobuynothing.app',
  playStoreListingUrl:
    'https://play.google.com/store/apps/details?id=org.buffalobuynothing.app',
  joinCta: {
    title: 'Join The Community',
    lines: [
      'Give what you can.',
      'Ask for what you need.',
      'Help keep Buffalo connected.'
    ]
  }
} as const;

export const ABOUT = {
  title: 'What Is Buffalo Buy Nothing?',
  body: 'Buffalo Buy Nothing is a local sharing community focused on reducing waste and helping people connect through generosity.',
  memberCan: [
...
export const HOW_IT_WORKS = [
  {
    ...
    examples: ['OFFER: Couch in Elmwood Village', 'ISO: Looking for baby clothes', 'TRADE: Books for board games', 'CURB ALERT: Free desk outside']
  },
  {
    step: 2,
...
export const COMMUNITY_FIRST = {
  ...
  intro: 'Buffalo Buy Nothing is built on:',
...
export const SUPPORT = {
  ...
  gofundmeBlurb:
    'Buffalo Buy Nothing is 100% free and ad-free — no paywalls, no ads, and your data is never sold. Running it still costs real money every month.',
  ...
  gofundmeDetail:
    'Behind the scenes, four paid services keep Buffalo Buy Nothing online. None of them are free long-term — together they are the monthly bill for a community app that will never charge neighbors or show ads.',
  costItems: [
    {
      name: 'Cursor',
...
export const DIRECTOR_MESSAGE = {
  ...
  name: 'Markeith White',
  title: 'TheBuffaloFree Director',
  headline: 'A note from your director',
  goal:
    'Buffalo Buy Nothing exists so neighbors can give freely, ask kindly, and keep good things out of the landfill — with no money involved. That is the goal, plain and simple.',
  promises: [
...
export const STAFF_MESSAGE_DEFAULT = {
  name: 'Buffalo Buy Nothing',
  title: 'Team member',
  headline: 'A note from our team',
  goal:
    'I help keep our Buffalo circle welcoming, fair, and focused on neighbors helping neighbors — with moderation, support, and community leadership.',
  promises: [
...
export const IN_APP = {
  ...
  feedDescription: 'Give away items, request what you need, trade with neighbors, and connect across Buffalo — 100% free.',
  mapTitle: 'Buffalo Neighborhood Map',
  mapDescription: 'Explore free gifts and requests across Buffalo. Message neighbors to arrange porch pickup.',
  ...
  onboardingTitle: 'Join Buffalo Buy Nothing',
  onboardingBody:
...
export const PRIVACY = {
  ...
  summary:
    'Buffalo Buy Nothing is run by Markeith White. I do not sell your information. Your account data is stored by Supabase — not on this website’s own servers.',
  sections: [
    {
      heading: 'Who runs this app',
      body:
        'Buffalo Buy Nothing is built and operated by Markeith White alone to help neighbors give freely and connect locally. This is not a commercial marketplace — there are no ads, no paywalls, and I do not sell your personal information.',
    },
    {
...
export const DELETE_ACCOUNT = {
  title: 'Delete your BuffaloBuyNothing account',
  shortTitle: 'Delete account',
  lastUpdated: 'August 2026',
  summary:
    'You can permanently delete your BuffaloBuyNothing account and associated data at any time from inside the app. Deletion is immediate and cannot be undone.',
  steps: [
    'Open BuffaloBuyNothing and sign in.',
  ...
  supportNote:
    'Questions about deletion? Contact staff through Chat → Support in the app, or email support@buffalobuynothing.org.',
...
export const TERMS = {
  ...
  lastUpdated: 'July 2026',
  summary:
    'By using Buffalo Buy Nothing, you agree to these terms. The app is run by Markeith White for local, free neighbor-to-neighbor gifting only — no selling, no flipping, no harassment.',
  sections: [
    {
      heading: 'Agreement',
      body:
        'These Terms of Use are a binding agreement between you and Markeith White, the sole operator of Buffalo Buy Nothing. By creating an account, signing in, or using the app, you agree to follow these terms, our community rules, and our Privacy & data policy.',
    },
    {
      heading: 'What this app is for',
      bullets: [
        'Giving away items for free to neighbors in the Buffalo area.',
    ...
    },
    {
      ...
      body:
        'To the fullest extent allowed by law, Markeith White and Buffalo Buy Nothing are not liable for indirect, incidental, or consequential damages arising from your use of the app, offline exchanges, or third-party services (including Supabase and Vercel). Your use of the app is at your own risk.',
    },
    {
      heading: 'Changes',
      body:
...
export const CHILD_SAFETY = {
  ...
  lastUpdated: 'August 2026',
  summary:
    'TheBuffaloFree has zero tolerance for child sexual abuse and exploitation (CSAE). These standards apply to the app, website, and every neighbor account.',
  contactEmail: 'support@buffalobuynothing.org',
  sections: [
    {
      heading: 'Our commitment',
      body:
        'Buffalo Buy Nothing is operated by Markeith White as a local, free neighbor-to-neighbor gifting community. We prohibit any content, behavior, or conduct that sexualizes, exploits, endangers, or harms children. CSAE is not allowed on our platform in any form.',
    },
    {
    ...
    },
    {
      ...
      body:
        'Google Play and law enforcement can reach our child-safety contact at support@buffalobuynothing.org. Include “Child safety” in the subject line. This contact can speak to our enforcement procedures and take action on CSAE reports.',
    },
  ],
} as const;
...
export const AWARDS = {
  ...
  shareTitle: 'Join Buffalo Buy Nothing',
  shareMessage:
    'Come join our free Buffalo Buy Nothing group — give, receive, and trade with neighbors. No money, just kindness: {url}',
  unlockedIntro:
...
export const EVENTS = {
  ...
  shareTitle: 'Join Buffalo Buy Nothing',
  shareMessage:
    'Come join our free Buffalo Buy Nothing group — give, receive, trade, and meet neighbors. No money, just kindness: {url}',
  unlockedIntro:
