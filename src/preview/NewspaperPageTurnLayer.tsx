...
export default function NewspaperPageTurnLayer() {
  ...
  return (
    <div
      key={turn.id}
      className={`tbf-page-turn tbf-page-turn--${compact ? 'compact' : 'sheet'} tbf-page-turn--${turn.direction}`}
      aria-hidden="true"
    >
      <div className="tbf-page-turn__leaf">
        <div className="tbf-page-turn__face tbf-page-turn__face--front" />
        <div className="tbf-page-turn__face tbf-page-turn__face--back" />
      </div>
      <div className="tbf-page-turn__shadow" />
    </div>
  );
}
