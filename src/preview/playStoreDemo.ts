...
export const PLAY_STORE_DEMO_PROFILE: UserProfile = {
  ...
  displayName: 'Quinn Harper',
  email: 'quinn.harper.demo@example.com',
  neighborhood: 'Elmwood Village',
  bio: 'Elmwood Village neighbor — giving away extras and borrowing what I need.',
  photoURL: avatar('Quinn Harper'),
  role: 'user',
...
const NEIGHBORS = {
  avery: { uid: 'demo-neighbor-avery', name: 'Nia Brooks', neighborhood: 'Allentown', photo: avatar('Nia Brooks') },
  jordan: { uid: 'demo-neighbor-jordan', name: 'Theo Walsh', neighborhood: 'Hertel / North Buffalo', photo: avatar('Theo Walsh') },
  sam: { uid: 'demo-neighbor-sam', name: 'Maren Cole', neighborhood: 'West Side', photo: avatar('Maren Cole') },
  casey: { uid: 'demo-neighbor-casey', name: 'Jules Patel', neighborhood: 'South Buffalo', photo: avatar('Jules Patel') },
  riley: { uid: 'demo-neighbor-riley', name: 'Devon Ruiz', neighborhood: 'Delaware District', photo: avatar('Devon Ruiz') },
  morgan: { uid: 'demo-neighbor-morgan', name: 'Cam Ortega', neighborhood: 'Grant-Ferry', photo: avatar('Cam Ortega') },
} as const;

export const PLAY_STORE_DEMO_ITEMS: ItemPost[] = [
  listing({
    id: 'demo-item-chair',
    title: 'Kids snow boots, size 2',
    type: 'giveaway',
    category: 'Baby & Kids',
    ...
    imageUrl: '/play-store-demo/boots.jpg',
    details: 'Toddler snow boots, size 2. One season of use, still waterproof. Porch pickup after 5.',
    pickupNotes: 'Leave a message and I’ll set them on the porch.',
    createdHoursAgo: 4,
  }),
  listing({
    id: 'demo-item-plants',
    title: 'Leftover firewood — half a cord',
    type: 'giveaway',
    ...
    imageUrl: '/play-store-demo/firewood.jpg',
    details: 'Split hardwood left from last winter. Take what you can carry — driveway pickup.',
    createdHoursAgo: 8,
  }),
  listing({
    id: 'demo-item-books',
    title: 'Navy throw blanket',
    type: 'giveaway',
    ...
    imageUrl: '/play-store-demo/blanket.jpg',
    details: 'Soft navy throw, gently used. Smoke-free home. Folded and ready on the stoop.',
    createdHoursAgo: 14,
  }),
  listing({
    ...
    imageUrl: '/play-store-demo/skillet.jpg',
    details: 'Well-seasoned 10-inch skillet. A little heat tint, still cooks great. Come as-is.',
    createdHoursAgo: 20,
  }),
  listing({
    id: 'demo-item-lamp',
    title: 'Looking for a winter coat for a teen',
    type: 'looking',
    category: 'Clothing Needed',
    ...
    details: 'Just moved to Delaware District and need a warm coat, size M/L teen. Happy to pick up this weekend.',
    createdHoursAgo: 6,
  }),
  listing({
    id: 'demo-item-porch-box',
    title: 'Porch pile: ice-fishing gear',
    type: 'giveaway',
    ...
    imageUrl: '/play-store-demo/porch-gear.jpg',
    details: 'Open box on the porch — folding stool, ice scoop, and a couple of tip-ups. First come.',
    createdHoursAgo: 2,
  }),
];
...
export const PLAY_STORE_DEMO_FEED_POSTS: FeedPost[] = [
  {
    ...
    userPhotoURL: NEIGHBORS.sam.photo,
    neighborhood: NEIGHBORS.sam.neighborhood,
    text: 'Hey guys — happy Saturday. Anyone else feeling grateful for this little corner of Buffalo lately?',
    imageUrls: [],
    status: 'active',
  ...
  },
  {
    ...
    userPhotoURL: NEIGHBORS.casey.photo,
    neighborhood: NEIGHBORS.casey.neighborhood,
    text: 'Lost my retail job last week. If anyone hears of part-time front desk or admin work around South Buffalo, please message me. Trying to stay hopeful.',
    imageUrls: [],
    status: 'active',
  ...
  },
  {
    ...
    userPhotoURL: NEIGHBORS.riley.photo,
    neighborhood: NEIGHBORS.riley.neighborhood,
    text: 'New in Delaware District and still learning the city. What do you wish someone had told you when you first moved to Buffalo?',
    imageUrls: [],
    status: 'active',
  ...
  'demo-feed-hey': [
    {
      ...
      text: 'Same here, Maren. This group has been a bright spot.',
  ...
  'demo-feed-job-ask': [
    {
      ...
      text: 'Sending you good energy, Jules. I will ask around at work too.',
    ...
    },
    {
      ...
      userPhoto: NEIGHBORS.morgan.photo,
      userNeighborhood: NEIGHBORS.morgan.neighborhood,
      text: "My cousin's cafe on Hertel might be hiring — I will check tomorrow.",
  ...
  'demo-feed-support': [
    {
      ...
      text: 'Thinking of you, Nia. I can meet for a walk Sunday morning if that helps.',
...
export const PLAY_STORE_DEMO_CHATS: Chat[] = [
  ...
  },
  {
    ...
    lastMessageText: 'Yes — I’ll leave the boots on the porch after 5.',
    lastMessageAt: hoursAgo(0.8),
    lastMessageSenderId: NEIGHBORS.avery.uid,
    itemId: 'demo-item-chair',
    itemTitle: 'Kids snow boots, size 2',
  },
  {
    id: 'demo-chat-plants',
    ...
    lastMessageText: 'I can save you a bundle — driveway pickup tomorrow.',
    lastMessageAt: hoursAgo(5),
    lastMessageSenderId: NEIGHBORS.jordan.uid,
    itemId: 'demo-item-plants',
    itemTitle: 'Leftover firewood — half a cord',
  },
  {
    id: 'demo-chat-lamp',
    ...
    lastMessageText: 'I have a winter coat in Delaware District if you can pick it up this weekend.',
    lastMessageAt: hoursAgo(2),
    lastMessageSenderId: NEIGHBORS.riley.uid,
    itemId: 'demo-item-lamp',
    itemTitle: 'Looking for a winter coat for a teen',
  },
];
