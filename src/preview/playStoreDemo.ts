...
const NEIGHBORS = {
  avery: { uid: 'demo-neighbor-avery', name: 'Avery Quinn', neighborhood: 'Allentown', photo: avatar('Avery Quinn') },
  jordan: { uid: 'demo-neighbor-jordan', name: 'Jordan Hale', neighborhood: 'Elmwood Village', photo: avatar('Jordan Hale') },
  sam: { uid: 'demo-neighbor-sam', name: 'Sam Rivera', neighborhood: 'West Side', photo: avatar('Sam Rivera') },
  casey: { uid: 'demo-neighbor-casey', name: 'Casey Brooks', neighborhood: 'North Buffalo', photo: avatar('Casey Brooks') },
  riley: { uid: 'demo-neighbor-riley', name: 'Riley Nguyen', neighborhood: 'Delaware District', photo: avatar('Riley Nguyen') },
  morgan: { uid: 'demo-neighbor-morgan', name: 'Morgan Ellis', neighborhood: 'Grant-Ferry', photo: avatar('Morgan Ellis') },
} as const;
...
export const PLAY_STORE_DEMO_ITEMS: ItemPost[] = [
  ...
  listing({
    ...
    details: 'Just moved to Delaware District and need a simple floor lamp. Happy to pick up this weekend.',
    createdHoursAgo: 6,
  }),
  listing({
...
export const PLAY_STORE_DEMO_EVENTS: CommunityEvent[] = [
  ...
  {
    id: 'demo-event-books',
    title: 'Elmwood Village book swap on the steps',
    description: 'Leave a book, take a book. Kids’ picture books especially welcome.',
    location: 'Elmwood stoop library',
    neighborhood: 'Elmwood Village',
...
export const PLAY_STORE_DEMO_FEED_POSTS: FeedPost[] = [
  ...
  },
  {
    ...
    userPhotoURL: NEIGHBORS.casey.photo,
    neighborhood: NEIGHBORS.casey.neighborhood,
    text: 'Lost my retail job last week. If anyone hears of part-time front desk or admin work around Elmwood Village, please message me. Trying to stay hopeful.',
    imageUrls: [],
    status: 'active',
...
export const PLAY_STORE_DEMO_CHATS: Chat[] = [
  ...
  },
  {
    ...
    lastMessageText: 'I have a floor lamp in Delaware District if you can pick it up this weekend.',
