...
const PENDING_DEEP_LINK_KEY = 'tbf_pending_deep_link_v1';
  ...
  useEffect(() => {
    ...
    const onPopState = (event: PopStateEvent) => {
      ...
      const fallbackTab =
        ...
        parseStoredTab(window.localStorage.getItem(`tbf_active_tab_v1_${sessionUserRef.current?.id ?? ''}`)) ||
        'map';
      handlingPopStateRef.current = true;
          ...
          {!userProfile ? (
            ...
            <div className="min-h-screen flex flex-col items-center justify-center gap-4 px-6 text-center mesh-bg">
              ...
              <p className="text-sm text-muted max-w-md leading-relaxed">
                {accountRestriction.reason === 'banned'
                  ? 'Your account has been disabled by community staff. Contact the Buffalo Buy Nothing team if you believe this is a mistake.'
                  : accountRestriction.reason === 'locked'
              ...
              <div className="min-w-0">
                ...
                <div className="text-[11px] text-muted mt-1.5 leading-relaxed font-semibold">
                  {isIOS ? (
                    ...
                    <span>Add to your home screen for quick access to free local gifting across Buffalo.</span>
                  )}
                </div>
              </div>
            </div>
