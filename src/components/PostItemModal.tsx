...
import { BUFFALO_NEIGHBORHOODS, ITEM_CATEGORIES, ISO_CATEGORIES, ISO_DELIVERY_PREFS, PostType, mapGPSToPercent, NEIGHBORHOOD_COORDS, findClosestNeighborhood, findClosestNeighborhoodByLatLng } from '../types';
          ...
          <div className="space-y-3 border-t border-app pt-4" id="post_location_coordinates_section">
            ...
            {showMiniMap &&
              <div className="border border-app bg-inset p-2 mt-2 select-none relative rounded-xl" id="sac_mini_map_picker_container">
                <div className="flex items-center justify-between pb-1.5 border-b border-app mb-2">
                  <span className="text-[8.5px] font-black text-subtle uppercase tracking-widest font-mono">Buffalo District map Grid</span>
            ...
            <div className="rounded-xl border border-app bg-inset/40 p-3 space-y-1.5">
              ...
              <input
                ...
                placeholder="e.g. 1234 Oak St, Buffalo — optional; sent with GPS in chat"
            ...
            <div className="flex items-center space-x-2.5">
              ...
              <div className="min-w-0">
                {newspaper && !isEditing && !isReposting ? (
                  <p className="tbf-kicker">Place a classified</p>
                ) : null}
