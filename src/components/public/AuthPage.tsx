...
export default function AuthPage({
  ...
  const [neighborhood, setNeighborhood] = useState('Elmwood Village');
      ...
      <div className="hidden lg:flex lg:w-[42%] xl:w-[38%] sbn-auth-brand-panel flex-col justify-between p-10 lg:p-12">
        {!newspaper ? (
          ...
          <div className="relative z-10">
            <p className="tbf-auth-panel-wordmark">{NEWSPAPER.the} {NEWSPAPER.title}</p>
          </div>
        )}
        ...
        <p className="relative z-10 text-xs font-semibold sbn-auth-brand-footnote">
          Free forever · No ads · Buffalo-owned and operated
        </p>
      </div>
