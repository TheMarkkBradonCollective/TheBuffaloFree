...
/** Upcoming link change — public home page (TheBuffaloFree edition). */
export default function TrademarkNoticeBanner() {
  if (isPlayStoreDemo()) return null;
  return (
    <aside
      className="tbf-legal-notice mx-4 mb-4 max-w-3xl lg:max-w-none lg:mx-auto sbn-card border-l-4 border-l-accent px-4 py-4 sm:px-5"
