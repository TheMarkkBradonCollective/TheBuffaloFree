    ...
    return (
      <>
        ...
        <div className={`grid gap-4 ${isPublicDownloadPage || showApkSection ? 'md:grid-cols-2' : ''}`}>
          ...
          <PublicCard className="h-full">
            ...
            <p className="text-[11px] text-subtle mt-3 leading-relaxed">
              ...
              BuffaloBuyNothing app first, then try again.
            </p>
          </PublicCard>
          ) : null}
        ...
        <PublicCard>
          ...
          <p className="text-xs text-muted mb-4 leading-relaxed">
            {isPublicDownloadPage
              ? 'Both connect to the same Buffalo community. Use Google Play on Android if you are on the invite list, or add to your home screen on any phone — no file download required for home screen.'
              : 'All options connect to the same Buffalo community. Home screen works everywhere. Google Play is the native Android path for most neighbors. Free APK sideload in Account is only for our first 500 joiners.'}
          </p>
