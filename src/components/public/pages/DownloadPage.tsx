  ...
  const shell = onBack ? (
        ...
        <header className="sbn-page-header">
          ...
          <p>
            {newspaper
              ...
              : 'See the screenshots first. Same Buffalo community as the website — live Go Get pickup is the Android extra. Google Play for most neighbors, home screen for everyone, and free APK sideload for our first 500 joiners.'}
          </p>
        </header>
    ...
    <PublicPageShell
      ...
      subtitle={
        newspaper
          ? `Take ${NEWSPAPER.name} with you — Google Play on Android or add to your home screen.`
          : 'See the app before you install — same Buffalo community as the website, plus live Go Get pickup on Android.'
      }
