...
const CONFETTI_COLORS = ['#00338D', '#0047AB', '#5D8FBF', '#E6EEF7', '#FFFFFF', '#002A72'];
      ...
      {open && (
        <>
          ...
          >
            ...
            >
              <div className="absolute inset-x-0 top-0 h-1.5 bg-gradient-to-r from-accent via-[#5D8FBF] to-accent" />
