...
import { ItemPost, PostStatus, BUFFALO_NEIGHBORHOODS, ITEM_CATEGORIES, ISO_CATEGORIES, UserProfile } from '../types';
import {
  ArrowDownUp,
  CircleDot,
  LayoutGrid,
...
export default function ItemGrid({
  ...
  const neighborhoodFilterOptions = useMemo(
    () => [
      ...
      ...BUFFALO_NEIGHBORHOODS.map((n) => ({ value: n, label: n })),
    ],
    [],
  );
